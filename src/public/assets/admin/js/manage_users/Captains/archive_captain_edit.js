...
$(document).ready(function () {
    ...
    //********************************************** Edit/Update Captain Archive List*******************************************************************
    ...
    $('#update_archive_captainlist_form').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: '/manage_user/captains/captain_update_archive_list/' + captain_id,
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
                    if (data.status == 'success') {
                        ...
                        window.location.href = '/manage_user/captains/captain_archived_list';
        ...
        //********************************************** Status Update Captain Archive List*******************************************************************
